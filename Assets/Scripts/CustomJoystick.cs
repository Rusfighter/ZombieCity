...
namespace UnityStandardAssets.CrossPlatformInput
{
	public class CustomJoystick : MonoBehaviour, IPointerDownHandler, IPointerUpHandler, IDragHandler
	{
		...
		public void OnDrag(PointerEventData data)
		{
			...
			pivotImage.position = Vector3.ClampMagnitude(new Vector3(newPos.x, newPos.y, newPos.z), MovementRange)+m_StartPos;
			UpdateVirtualAxes(pivotImage.position);
		}
		
		
		public void OnPointerUp(PointerEventData data)
		{
			pivotImage.position = m_StartPos;
